        ...
        >
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
            ...
            <div className="shrink-0">
              <a href="https://github.com/gestions-UO/devhelp-dev-tools" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 px-8 py-4 bg-white text-gray-900 font-bold uppercase tracking-widest text-sm rounded-full hover:bg-gray-100 transition-colors shadow-sm hover:shadow-md hover:-translate-y-0.5">
